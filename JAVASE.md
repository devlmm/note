...
- [**第一部分：编程基础**](#第一部分编程基础)
  - [1.1 基本数据类型（4类8种）](#11-基本数据类型4类8种)
  - [1.2 类型转换](#12-类型转换)
  - [1.3 进制转换](#13-进制转换)
  - [1.4 编码规范](#14-编码规范)
  - [1.5 运算符](#15-运算符)
  - [1.6 控制语法](#16-控制语法)
- [**第二部分：面向对象入门**](#第二部分面向对象入门)
  - [2.1 类与对象的基本概念](#21-类与对象的基本概念)
  - [2.2 代码块](#22-代码块)
  - [2.3 关键字](#23-关键字)
  - [2.4 封装](#24-封装)
  - [2.5 继承与多态基础](#25-继承与多态基础)
- [**第三部分：面向对象进阶**](#第三部分面向对象进阶)
  - [3.1 抽象类与接口](#31-抽象类与接口)
  - [3.2 枚举类（enum）](#32-枚举类enum)
  - [3.3 内部类](#33-内部类)
  - [3.4 包装类与自动拆装箱](#34-包装类与自动拆装箱)
  - [3.5 向上转型与向下转型](#35-向上转型与向下转型)
- [**第四部分：异常处理**](#第四部分异常处理)
  - [4.1 Throwable 体系](#41-throwable-体系)
  - [4.2 异常处理语法](#42-异常处理语法)
  - [4.3 异常链与自定义异常](#43-异常链与自定义异常)
- [**第五部分：数组与常用工具类**](#第五部分数组与常用工具类)
  - [5.1 数组](#51-数组)
  - [5.2 Arrays 工具类](#52-arrays-工具类)
  - [5.3 Comparable 与 Comparator](#53-comparable-与-comparator)
  - [5.4 字符串家族](#54-字符串家族)
  - [5.5 其他常用工具类](#55-其他常用工具类)
- [**第六部分：泛型**](#第六部分泛型)
  - [6.1 泛型基础](#61-泛型基础)
  - [6.2 泛型通配符](#62-泛型通配符)
- [**第七部分：容器框架（集合）**](#第七部分容器框架集合)
  - [7.1 体系概览](#71-体系概览)
  - [7.2 List](#72-list)
  - [7.3 Set](#73-set)
  - [7.4 Map](#74-map)
  - [7.5 Queue / Deque](#75-queue--deque)
  - [7.6 迭代器与 Collections](#76-迭代器与-collections)
- [**第八部分：IO 流（基础）**](#第八部分io-流基础)
  - [8.1 流分类](#81-流分类)
  - [8.2 文件流 + 缓冲流](#82-文件流--缓冲流)
  - [8.3 数据流与对象流](#83-数据流与对象流)
  - [8.4 Apache Commons IO](#84-apache-commons-io)
- [**第九部分：NIO（New I/O）—— IO 进阶**](#第九部分nio-new-io--io-进阶)
  - [9.1 核心组件](#91-核心组件)
  - [9.2 Buffer 操作](#92-buffer-操作)
  - [9.3 Channel 与 Selector](#93-channel-与-selector)
- [**第十部分：多线程（基础）**](#第十部分多线程基础)
  - [10.1 线程创建方式](#101-线程创建方式)
  - [10.2 线程生命周期](#102-线程生命周期)
  - [10.3 线程常用方法](#103-线程常用方法)
  - [10.4 synchronized 与 volatile](#104-synchronized-与-volatile)
  - [10.5 wait / notify / notifyAll](#105-wait--notify--notifyall)
- [**第十一部分：JUC 并发包 —— 多线程进阶**](#第十一部分juc-并发包--多线程进阶)
  - [11.1 线程池](#111-线程池)
  - [11.2 锁框架](#112-锁框架)
  - [11.3 原子类](#113-原子类)
  - [11.4 并发容器](#114-并发容器)
  - [11.5 同步工具](#115-同步工具)
  - [11.6 ThreadLocal](#116-threadlocal)
- [**第十二部分：网络编程**](#第十二部分网络编程)
  - [12.1 TCP 编程](#121-tcp-编程)
  - [12.2 UDP 编程](#122-udp-编程)
- [**第十三部分：反射、类加载机制与动态代理**](#第十三部分反射类加载机制与动态代理)
  - [13.1 反射（Reflection）](#131-反射reflection)
  - [13.2 类加载机制（ClassLoader）](#132-类加载机制classloader)
  - [13.3 动态代理（Dynamic Proxy）](#133-动态代理dynamic-proxy)
- [**第十四部分：注解（Annotation）**](#第十四部分注解annotation)
  - [14.1 内置注解与元注解](#141-内置注解与元注解)
  - [14.2 自定义注解 + 反射解析](#142-自定义注解--反射解析)
- [**第十五部分：Lambda 与函数式编程**](#第十五部分lambda-与函数式编程)
  - [15.1 Lambda 表达式与函数式接口](#151-lambda-表达式与函数式接口)
  - [15.2 Stream API](#152-stream-api)
- [**第十六部分：常用工具类补充**](#第十六部分常用工具类补充)
  - [16.1 Optional 类（避免空指针）](#161-optional-类避免空指针)
  - [16.2 时间 API（java.time，Java 8+）](#162-时间-apijavatime-java-8)
- [**第十七部分：数据结构与简单算法**](#第十七部分数据结构与简单算法)
  - [17.1 数据结构基础](#171-数据结构基础)
  - [17.2 常用算法](#172-常用算法)
- [**第十八部分：JVM 内存结构与垃圾回收**](#第十八部分jvm-内存结构与垃圾回收)
  - [18.1 运行时数据区](#181-运行时数据区)
  - [18.2 对象创建与内存布局](#182-对象创建与内存布局)
  - [18.3 垃圾回收（GC）](#183-垃圾回收gc)
  - [18.4 类加载过程](#184-类加载过程)
  - [18.5 Java 内存模型（JMM）](#185-java-内存模型jmm)
...
<img src="assets/JVM内存结构图.png?t=1780928299781" width="700">
